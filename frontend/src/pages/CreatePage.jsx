...
const CreatePage = () => {
  ...
  return (
    ...
    <div className='max-w-2x1 x-auto'>
    ...
    <ArrowLeftIcon className='size-5'/>Back to Books</Link> 
      ...
      <input text="text" placeholder='Book Author' className='input input-bordered' vlaue={author} onChange={(e)=>
      ...
      <input text='number' placeholder='e.g. 2025' className='input bordered' value={publishYear} onChange={(e)=>
